                ...
                >
                    ...
                    <div className="rounded-xl bg-card border border-border shadow-card px-5 py-5 flex flex-col sm:flex-row items-center gap-3">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="flex items-center justify-center gap-2 w-full sm:flex-1 rounded-lg bg-primary px-6 py-2.5 text-sm font-semibold text-primary-foreground hover:opacity-90 transition-all shadow-sm"
                        >
